...
training_set = dataset_train.iloc[:, 1:2].values  # Opening Price as a Numpy array
...
# Display the first few rows of the training dataset (debugging)
print(dataset_train.head())  # Print instead of display
